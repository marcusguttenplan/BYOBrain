      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              "",
              "**IMPORTANT**: Reply in Telegraphic Mode (bullet points only, zero prose).",
              "",
      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              "",
              "**IMPORTANT**: Reply in Telegraphic Mode (bullet points only, zero prose).",
              "If you are mutating state via tools, ensure you first set the correct agent_state (\`planning\` vs \`execution\`).",
              "",
              `Brain directory: ${brainDir}`,
            ].join("\n"),
          },
